      ...
      <div className="container">
        ...
        <div className="about-content">
          ...
          <div className="about-text">
            ...
            <p>
              When you choose THE SLAB DESIGN STUDIO you can expect a seamless and collaborative process that puts your needs and aspirations at the forefront. We are committed to working closely with you, providing regular updates, and incorporating your feedback throughout the design process.
            </p>
